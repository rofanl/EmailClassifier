 ...
 */
QString Chrono::get_StartTime(void) const
{
 ...
 * @return     The end time.
 */
QString Chrono::get_EndTime(void) const
{
...
void Chrono::stopChrono(void)
{
    ...
    totalTime_ +=
        std::chrono::duration_cast<std::chrono::microseconds>(endClock_ - startClock_).count();
}
...
float Chrono::get_Seconds(int decimalAmmount)
{
    ...
    time /= 1000000;
    QString aux = QString::number(time);
    QString copy = "";
    int counter = 0;
    bool decimals = false;
