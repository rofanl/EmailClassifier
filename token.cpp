 ...
 * @return     The name.
 */
QString Token::get_Name(void) const
{
    return name_;
}
...
float Token::get_MultiClass(unsigned pos) const
{
    if (pos < multiClass_.size())
        ...
        std::cout << std::endl
                  << get_Name().toStdString() << " Error, pos must be lower than multiClass_ size."
                  << std::endl;
        exit(1);
    }
}
 ...
 * @return     The type.
 */
QString Token::get_Type(void) const
{
    return type_;
}
 ...
 * @param[in]  name  The name
 */
void Token::set_Name(QString name)
{
    name_ = name;
}
 ...
 */
void Token::set_Type(QString newType)
{
    type_ = newType;
}
 ...
 * @return     The result of the less-than comparison
 */
bool Token::operator<(const QString &str) const
{
    return (get_Name() < str);
}
 ...
 */
void Token::addClassProb(float prob, QString newClass)
{
...
void Token::printToken(void) const
{
    std::cout << std::endl
              << "Token Info:" << std::endl
              << "\t - Name: " << get_Name().toStdString() << std::endl
              << "\t - Ammount: " << get_Ammount() << std::endl
              << "\t - Type: " << get_Type().toStdString() << std::endl
